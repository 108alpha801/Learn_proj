...
function searchClick() {
  ...
  var resultsDOM = document.getElementById("searchResults");

  var results = findLocationByTopic(topicToFind);

  if (results) {
    var innerDOM = `<div class="container-fluid">`;
    results.forEach((location) => {
      innerDOM += `<div class="card border mb-2 rounded text-bg-secondary">
                      <img class="card-img-top" width="300" height="200" src=" ${location.imageUrl}">
                      <div class="card-body">
